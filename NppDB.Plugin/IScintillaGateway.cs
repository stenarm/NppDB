...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    ...
    public interface IScintillaGateway
    {
        ...
        /// </summary>
        void AutoCShow(int lengthEntered, string itemList);
        ...
        void ToggleFoldShowText(int line, string text);
        ...
        /// </summary>
        int SearchNext(FindOption searchFlags, string text);
        ...
        /// </summary>
        int SearchPrev(FindOption searchFlags, string text);
